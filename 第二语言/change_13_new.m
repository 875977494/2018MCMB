function [check,newcheck] = change_13_new(check,p_life,p_out,p_died,aa,ab)
 
newcheck = check(120:130,86:105);
aa = aa(:,13);
ab = ab(:,13);
...
%% kaishixunhaun 
for i = 1:length(s1)
    newcheck(a(s1(i)),b(s1(i))) = -13;
end
 
for i = 1:length(s2)
    newcheck(a(s2(i)),b(s2(i))) = -13;
end
...
for i = 1:length(ss16)
    newcheck(c(ss16(i)),d(ss16(i))) = 0.13;
end
...
for i = 1:length(sss16)
    newcheck(e(sss16(i)),f(sss16(i))) = -13;
end
 
for i = 1:length(sss17)
    newcheck(e(sss17(i)),f(sss17(i))) = -13;
end

check(120:130,86:105) = newcheck;
